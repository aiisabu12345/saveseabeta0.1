...
public class UpgradeHpButton : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        scoreToRemove = PlayerPrefs.GetInt("ScoreToRemoveHp", 0);
    ...
    void SaveScore(int score, int scoreToRemove)
    {
        ...
        PlayerPrefs.SetInt("ScoreToRemoveHp", scoreToRemove);
        PlayerPrefs.Save();
    }
    ...
    public void UpgradeHp()
    {
        ...
        // การปรับmaxspeed
        Playerupgradevalue.maxHp += 50f;
        
        upgradeRound = PlayerPrefs.GetInt("upgradehp",0);
        // Increment upgradeRound for the next round
        upgradeRound++;

        PlayerPrefs.SetInt("upgradehp",upgradeRound);
    ...
    public void DeductScore(int amount)
    {
        score = PlayerPrefs.GetInt("Score", 0);
        score -= amount;
        SaveScore(score, PlayerPrefs.GetInt("ScoreToRemoveHp", 0));
        UpdateScore(score, PlayerPrefs.GetInt("ScoreToRemoveHp", 0));
    }
}
